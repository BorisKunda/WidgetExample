...
//This is an optional Activity that launches when the user adds your App Widget and allows him to modify App Widget settings at create-time.

public class NewAppWidgetConfigureActivity extends Activity {

    private static final String PREFS_NAME = "com.happytrees.widgettutorial.NewAppWidget";
